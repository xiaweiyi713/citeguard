...
_SDIST_RELEASE_FILES = {
    ...
    "citeguard/benchmark/human_adjudication.py",
    "citeguard/benchmark/human_promotion.py",
    ...
    "scripts/promote_human_support_candidates.py",
    "scripts/prepare_human_support_adjudications.py",
