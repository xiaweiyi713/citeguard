...
class PackageSmokeTests(unittest.TestCase):
    ...
    def test_sdist_release_files_include_configuration_contract_doc(self):
        ...
        self.assertIn("docs/agent_output_contract.md", expected_release_files)
        self.assertIn("citeguard/contracts/v1/agent-output.schema.json", expected_release_files)
        self.assertIn("citeguard/contracts/v1/skill-trigger-prediction.schema.json", expected_release_files)
        self.assertIn("docs/human_benchmark_protocol.md", expected_release_files)
        self.assertIn("data/eval/human_support_benchmark_campaign.json", expected_release_files)
        self.assertIn("scripts/audit_human_support_benchmark.py", expected_release_files)
        self.assertIn("scripts/freeze_human_support_benchmark_test_split.py", expected_release_files)
        self.assertIn("docs/live_retrieval_benchmark_protocol.md", expected_release_files)
        self.assertIn("data/eval/live_retrieval_benchmark_campaign.json", expected_release_files)
        self.assertIn("data/eval/live_retrieval_benchmark.json", expected_release_files)
        self.assertIn("data/eval/live_retrieval_pilot_requests.json", expected_release_files)
        self.assertIn("data/eval/human_support_candidates.json", expected_release_files)
        self.assertIn("data/eval/human_support_pilot_claims.json", expected_release_files)
        self.assertIn("scripts/audit_live_retrieval_benchmark.py", expected_release_files)
        self.assertIn("scripts/observe_live_retrieval_benchmark.py", expected_release_files)
        self.assertIn("scripts/summarize_live_retrieval_observations.py", expected_release_files)
        self.assertIn("scripts/collect_live_retrieval_cases.py", expected_release_files)
        self.assertIn("scripts/build_human_support_candidates.py", expected_release_files)
        self.assertIn("scripts/merge_human_support_annotations.py", expected_release_files)
        self.assertIn("scripts/audit_human_support_candidates.py", expected_release_files)
        self.assertIn("scripts/generate_sbom.py", expected_release_files)
        self.assertIn("citeguard/verification/document_audit.py", expected_release_files)
        self.assertIn("citeguard/verification/intext.py", expected_release_files)
        self.assertIn("citeguard/verification/document_report.py", expected_release_files)
        self.assertIn("data/eval/support_hard_cases_v1.json", expected_release_files)
        self.assertIn("citeguard/evidence.py", expected_release_files)
