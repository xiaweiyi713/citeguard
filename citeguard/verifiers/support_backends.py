...
class SentenceTransformerRerankerBackend(SupportBackend):
    ...
    def assess(self, claim_text: str, evidence_text: str) -> SupportAssessment:
        ...
        try:
            ...
            return _model_unavailable_assessment(
                self.backend_name,
                self.model_name,
                exc,
                "Sentence-transformers backend failed to load or run.",
            )
    ...
    def assess(self, claim_text: str, evidence_text: str) -> SupportAssessment:
        ...
        try:
            ...
            return _model_unavailable_assessment(
                ...
                self.model_name,
                exc,
                "Transformers NLI backend failed to load or run.",
            )
...
def _model_unavailable_assessment(
    backend_name: str,
    model_name: str,
    exc: Exception,
    rationale: str,
